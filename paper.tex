...
\par For any \(I \subseteq \{1, ..., k\}\) and any values \((\rho_{i_\alpha})_{\alpha \in I'}\) such that (1) \(\rho_{i_\alpha} \leq \lambda_{i_\alpha}\) and (2) \(\rho_{i_\alpha}\) is decreasing with \(\alpha\), define 
