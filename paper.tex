...
\par Let \(\mathfrak{g} = \gl_m \times \gl_{m + n}\), with \(n > 0\).
...
We have a map \(\widetilde{\mathcal{N}} \to \mathcal{N} \hookrightarrow \mathfrak{g}\) given by the Springer resolution.
...
\par In this paper we will study \(S \times_\mathfrak{g} \widetilde{\mathcal{N}}\).
...
\par As a step towards studying \(S \times_\mathfrak{g} \widetilde{\mathcal{N}}\), we consider the map \(S \times_\mathfrak{g} \widetilde{\mathcal{N}} \to \gl_m\) given by taking the map to \(\mathfrak{g}\) and then projecting to \(\gl_m\).
...
In this section we prove linear algebra facts that will be used later.
They are proved in this section to avoid interrupting the flow of the remainder of the paper.
