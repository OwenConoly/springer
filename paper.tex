...
As in section 5, we write \(X = J(\lambda) \in \gl_m\), where \(\lambda = (\lambda_1, ..., \lambda_\ell)\).
...
where \(X' = J(\lambda')\), and \(\lambda' = (\lambda_1, ..., \lambda_w - r, ..., \lambda_\ell)\), and \(m' = m - r\), and \(n' = n + r\).
...
\begin{theorem}\label{qwr_comps}
    ...
    Each has dimension \(\sum_{i \leq j} \min(\lambda_i', \lambda_j')\), where \(\lambda' = (\lambda_1, ..., \lambda_{w - 1}, \lambda_w - r, \lambda_{w + 1}, ..., \lambda_\ell)\).
\end{theorem}
\begin{proof}
...
\begin{lemma}\label{gwr_irred_dim}
    \(G_{wr}\) is irreducible and has dimension \(\sum_{ij} \min(\lambda_i, \lambda_j')\), where \(\lambda' = (\lambda_1, ..., \lambda_{w - 1}, \lambda_w - r, \lambda_{w + 1}, ..., \lambda_\ell)\).
\end{lemma}
\begin{proof}
