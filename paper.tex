...
\begin{corollary}\label{sn_iso}
    \begin{align*}
        ...
        \{(A_{X, a, b}, \mathfrak{b}) : X \in \gl_m; a,b \in \mathbb{C}; \mathfrak{b} \in \mathcal{B}; (X, A_{X, a, b}) \in \mathfrak{b} \cap \mathcal{N}\} & .
    \end{align*}
\end{corollary}
...
\[\pi^{-1}(X) \cong \{(A_{X, a, b}, \mathfrak{b}_{m + n}) : a,b \in \mathbb{C}; A_{X, a, b} \in \mathfrak{b}_{m + n} \cap \mathcal{N}_{m + n}\} \times \{\mathfrak{b}_m : X \in \mathfrak{b}_m\}.\]
