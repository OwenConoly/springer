...
\par So, our strategy will be to find a subset of \(U_0\) such that \(A_{0,b}\) has some fixed Jordan form \(\mu\), and we have an algebraic map \(b \mapsto P\) such that for \(A_{0,b}\) in the subset, \(PJ(\mu)P^{-1} = A_{0,b}\).
