...
\par In section 5 we defined the subvarieties \(\mathcal{P}_{wr} \subseteq \mathcal{P}\) and the principal \(G_{wr}\)-bundle \(\varphi_{wr} : \mathcal{Q}_{wr} \times G \to \mathcal{P}_{wr}\).
