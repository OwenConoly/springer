...
\begin{proof}
    ...
    \begin{proof}[Proof of (3)]
        ...
        \par CONTINUE HERE.
        Now we are left with showing that \(\langle e_{ij} \rangle_{i,j : q_i < n} \subseteq W\).
        This is obvious for \(i \notin I\).
        So, we just need to show that \(e_{i_kj}\)
...
\begin{proof}
    ...
    This gives us the isomorphism \(B_{I, (\rho_i)} \times X_\mu \to \mathcal{Q}_{I, (\rho_i)}\).
...
\begin{corollary}\label{u_i_rho_irred_and_dim}
    The 
    \(\mathcal{Q}_{I, (\rho_i)}\) is irreducible, and its dimension is \(\gamma([0, \lambda_1, ..., \lambda_k])\).
\end{corollary}
\begin{proof}
...
\begin{lemma}
    The irreducible components of \(\mathcal{Q}_{I, (\rho_i)}\) are exactly the subvarieties 
