...
\begin{corollary}
    Every irreducible components of \(\mathcal{P}\) is the closure of some subvariety of the form \(\varphi_{wr}(\mathcal{Q}_{w,r,I,(\rho_i),\alpha} \times G)\), and the closure of each subvariety of this form is an irreducible component.
    Each has dimension \(\sum_{ij} \min(\lambda_i, \lambda_j)\).
\end{corollary}
\begin{proof}
