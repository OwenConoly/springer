...
\end{proof}
\par TODO: explain here why we are finding a Jordan basis here.
Fix any \(I\) and \((\rho_i)\) as in Lemma 8.1.
We will find an algebraic map \(b \mapsto P_b\) with the desired property.
This is equivalent to finding an algebraic map taking \(b\) to a Jordan basis for \(A_{0,b}\).
This is what we do.
