...
In this section we prove some facts about linear algebra that will be useful to us later.
...
\begin{lemma}
    Let \(\lambda = (\lambda_1, ..., \lambda_k)\) be a partition.
    The centralizer of \(J(\lambda)\) is the set of matrices 
    \[M = \begin{pmatrix}
        M_{11} & \cdots & M_{1k}\\
        \vdots &        & \vdots\\
        M_{k1} & \cdots & M_{kk}
